...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        num_cards_opp = len(opponent.deck.cards)
        index = 0
        while index < num_cards_opp:
            opp_deck_card = opponent.deck.cards[index]
            if opp_deck_card.attack == opponent_card.attack and opp_deck_card.defense == opponent_card.defense:
                opponent.deck.cards.pop(index)
                num_cards_opp -= 1
            else:
                index += 1
